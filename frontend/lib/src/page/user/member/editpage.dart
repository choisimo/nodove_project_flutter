          ...
          return SizedBox(
            ...
            child: SingleChildScrollView(
              child: Column(
                  ...
                  children: [
                    const SettingTitle(title: "프로필"),
                    SettingContent(children: [
                      const SizedBox(height: 16),
                      ProfileSetting(
                          current: user.profile, onUpdated: (image) {}),
                    ...
                    SettingContent(
                      children: [
                        ...
                        SelectedDateButton(
                          title: "생년월일 : ",
                          date: _con.editInfo['birthDate'] ??
                              getMilisecondToDateTime(
                                  _con.userInfo.value.birthDate),
                          mode: "Date",
                          onSubmitted: (dt) {
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                        ...
                                        color: Theme.of(context)
                                            ...
                                            .secondary)),
                                child: Text(
                                    "성별 : ${(_con.editInfo['gender'] == "M") ? "남" : (_con.editInfo['gender'] == "F") ? "여" : "그 외"}"))),
                        const SizedBox(height: 8),
                        SizedBox(
                          width: maxWidth * 0.8,
                          child: CommonTextInput(
